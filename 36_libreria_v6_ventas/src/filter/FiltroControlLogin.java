...
public class FiltroControlLogin implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		//recuperamos la dirección original solicitada y si quiere autenticarse
				...
				if(path.equals("/")||(path.equals("/Controller")&&param.equals("toAltaNuevo")||(path.equals("/Controller")&&param.equals("doAutenticar")))) {
				...
				if(sesion.getAttribute("clienteAutenticado")!=null) {
					...
					request.getRequestDispatcher("autentificacion.jsp").forward(request, response);
				}
			}
